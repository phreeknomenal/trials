module Admin
  class NavComponent < ApplicationComponent
    ...
    def links
      {"Overview" => admin_root_path, "Operations" => admin_operations_path, "Users" => admin_users_path, "Testimonials" => admin_testimonials_path, "Messages" => admin_contact_messages_path}
    end
