...
ActiveRecord::Schema[8.1].define(version: 2026_09_24_030652) do
  ...
  create_table "contact_messages", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["answered_at", "created_at"], name: "index_contact_messages_on_answered_at_and_created_at"
  end
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.check_constraint "onboarding_step >= 1", name: "profiles_onboarding_step_positive"
  end
